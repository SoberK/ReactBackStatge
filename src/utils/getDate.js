...
export function getYearStartDate() {
  var lastMonthStartDate = new Date(nowYear, 0, 1)
  return formatDate(lastMonthStartDate)
}
// 获得今年结束时间
export function getYearEndDate() {
  var lastMonthEndDate = new Date(nowYear, 11, getMonthDays(lastMonth))
  return formatDate(lastMonthEndDate)
}
// 获得去年开始时间
...
// 获得去年结束时间
export function getLastearEndDate() {
  var lastMonthEndDate = new Date(nowYear - 1, 11, getMonthDays(lastMonth))
  return formatDate(lastMonthEndDate)
}
